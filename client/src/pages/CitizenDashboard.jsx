        ...
        return (
          <div className="form-step active">
            ...
            <div className="input-wrapper">
              <TitleIcon />
              <input type="text" placeholder="e.g., Large pothole on Main Street" value={title} onChange={(e) => setTitle(e.target.value)} required />
            </div>
            <div className="input-wrapper">
              <DescIcon />
        ...
        return (
          <div className="form-step active">
            ...
            <div className="input-wrapper file-input">
                <MediaIcon />
                <label htmlFor="file-upload">{mediaFiles.length > 0 ? `${mediaFiles.length} file(s) selected` : 'Upload Photo/Video'}</label>
                <input id="file-upload" type="file" accept="image/*,video/*" capture="environment" multiple onChange={handleFileChange} />
            </div>
